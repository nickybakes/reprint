...
public class TravelingDisplay : Display
{
    ...
    /// </summary>
    private RectTransformDetails startTransformData;

    /// <summary>
    /// The transform data to travel towards.
    /// </summary>
    private RectTransformDetails goalTransformData;
    ...
    {
        startTransformData = new RectTransformDetails(rectTransform);
        goalTransformData = new RectTransformDetails(rectTransform);
    }
