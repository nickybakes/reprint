...
/// </summary>
public class FloatingDisplaySpace
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="_display">The card display that is tied to this position.</param>
    ...
    {
        Setup(_display, _spaceIndexPosition);
    }
    ...
    /// <param name="_display">The card display that is tied to this position.</param>
    /// <param name="_spaceIndexPosition">The index in the hand that this space is trying to be at.</param>
    public void Setup(FloatingDisplay _display, float _spaceIndexPosition)
    {
        display = _display;
        SetGoalSize(1);
